...
static struct notifier_block dt2w_notif;
...
static int dt2w_notifier_callback(struct notifier_block *this,
...
static int __init doubletap2wake_init(void)
{
	...
	dt2w_notif.notifier_call = dt2w_notifier_callback;
	if (lcd_register_client(&dt2w_notif) != 0) {
...
#endif
	lcd_unregister_client(&dt2w_notif);
